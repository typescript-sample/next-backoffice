...
import {formatDate, formatDateTimeToString} from "./_app";
                ...
                <form id='rolesForm' name='rolesForm' noValidate={true} ref={refForm as any}>
                    <section className='row search-group inline'>
                        ...
                        <label className='col s12 m4 l4'>
                            ...
                            <input type='datetime-local' id='time_min' name='time_min' data-field='time.min' value={formatDateTimeToString(filter?.time?.min || '')} onChange={updateState} />
                            <input type='datetime-local' id='time_max' name='time_max' data-field='time.max'  value={formatDateTimeToString(filter?.time?.max || '')} onChange={updateState} />
                        </label>
                    </section>
